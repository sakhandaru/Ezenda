      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border border-border shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-foreground">Masuk</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Button variant="outline" className="w-full border-border bg-background text-foreground hover:bg-accent">
        ...
        <div className="text-center mt-8">
          <p className="text-muted-foreground text-sm">© 2024 Ezenda. Semua hak dilindungi.</p>
        </div>
      </div>
    </div>
  )
